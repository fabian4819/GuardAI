...
export function Navbar() {
  ...
  return (
    <nav ref={navRef} className="sticky top-0 z-50 w-full border-b border-gray-800 bg-gray-950/80 backdrop-blur-md overflow-hidden">
          ...
          <div className="flex items-center gap-4">
            {mounted && isConnected ? (
              ...
              <motion.button
                ...
                className="bg-blue-600 hover:bg-blue-500 text-white px-5 py-2 rounded-xl text-sm font-semibold shadow-lg shadow-blue-900/20 transition-all"
              >
                Connect Wallet
              </motion.button>
            ) : (
