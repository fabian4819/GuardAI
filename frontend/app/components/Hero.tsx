    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center pt-24 scale-90 md:scale-100 origin-top">
        ...
        <div className="relative w-full max-w-4xl mx-auto h-80">
          ...
          <div className="floating-card absolute left-[-25%] md:left-[-25%] top-20 w-70 aspect-4/3 bg-[#0a1518]/80 backdrop-blur-xl rounded-2xl border border-white/10 p-6 z-10 -rotate-12 opacity-50 text-left">
          ...
          <div className="floating-card absolute right-[-25%] md:right-[-25%] top-20 w-70 aspect-4/3 bg-[#0a1518]/80 backdrop-blur-xl rounded-2xl border border-white/10 p-6 z-10 rotate-12 opacity-50 text-left">
